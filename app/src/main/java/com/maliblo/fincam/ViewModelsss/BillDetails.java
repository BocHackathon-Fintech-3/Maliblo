...
import com.maliblo.fincam.AmaountImp;
import com.maliblo.fincam.Constants;
import com.maliblo.fincam.R;
import com.maliblo.fincam.network.BocAccountsService;
import com.maliblo.fincam.network.BocAuthorizationService;
import com.maliblo.fincam.network.BocSubscriptionService;
import com.maliblo.fincam.utils.Utilities;
import com.maliblo.fincam.view.AccountActivity;
import com.maliblo.fincam.view.PaymentActivity;
...
public class BillDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String invoiceNo = getIntent().getExtras().getString("INVOICE_NO");
        String invoiceCheckDigits = getIntent().getExtras().getString("INVOICE_CHECK_DIGITS");
        String total = getIntent().getExtras().getString("TOTAL");
        String getBill = getIntent().getExtras().getString("BILL");
        String getID = getIntent().getExtras().getString("ID");
        String imagePath = getIntent().getExtras().getString("IMAGE_PATH");

        Button anaButton=findViewById(R.id.anaButton);
        LinearLayout linearLayout = findViewById(R.id.card_onPayment);
        LinearLayout cardBtnOnPay = findViewById(R.id.card_btnOnPay);
        ProgressBar progressBar = findViewById(R.id.progressbar_onPayment);
        TextView invoiceNoTV = findViewById(R.id.invoice_number);
        TextView invoiceCheckDigitsTV = findViewById(R.id.check_digits);
        TextView totalTV = findViewById(R.id.totalBill);
        TextView barcodeTV = findViewById(R.id.barcode);
        TextView companyTV = findViewById(R.id.company_name);
        ImageView imageView = findViewById(R.id.billImage);

        if (total!=null){
            AmaountImp.setTotalValue(total, getApplicationContext());
        }

        if (company != null) {
            cardBtnOnPay.setVisibility(View.VISIBLE);
            imageView.setVisibility(View.VISIBLE);
            linearLayout.setVisibility(View.VISIBLE);
            progressBar.setVisibility(View.GONE);
            anaButton.setVisibility(View.VISIBLE);
        } else {
            linearLayout.setVisibility(View.INVISIBLE);
            linearLayout.setVisibility(View.GONE);
            imageView.setVisibility(View.GONE);
            progressBar.setVisibility(View.VISIBLE);
            cardBtnOnPay.setVisibility(View.INVISIBLE);
            anaButton.setVisibility(View.INVISIBLE);
        }
        ...
        invoiceCheckDigitsTV.setText(invoiceCheckDigits);
        ...
        payBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Log.d(Constants.LOG_TAG, "Init payments");
                ...
                mSubscriptionService
                        ...
                        .subscribeWith(new DisposableSingleObserver<CreateSubscriptionResponse>() {
                            ...
                            public void onSuccess(CreateSubscriptionResponse response) {
                                ...
                                startActivityForResult(browserIntent, Constants.LOG_IN);
                            }
